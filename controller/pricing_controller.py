...
def save_manual_rate():
    try:
        ...
        return jsonify({"status": "success", "message": "Tasa guardada"})
    except Exception as e:
        return jsonify({"status": "error", "message": str(e)}), 500
...
def update_settings():
    try:
        ...
        return jsonify({"status": "success", "message": "Configuracion actualizada"})
    except Exception as e:
        return jsonify({"status": "error", "message": str(e)}), 500
