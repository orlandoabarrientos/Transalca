...
MAIL_SERVER = os.getenv("TRANSALCA_MAIL_SERVER", "mail.spacemail.com")
MAIL_PORT = _env_int("TRANSALCA_MAIL_PORT", 465)
MAIL_USERNAME = os.getenv("TRANSALCA_MAIL_USERNAME", "info@transalcagroup.com")
MAIL_PASSWORD = os.getenv("TRANSALCA_MAIL_PASSWORD", "Transalca123.")
MAIL_SENDER_NAME = os.getenv("TRANSALCA_MAIL_SENDER_NAME", "Transalca C.A.")
MAIL_DEFAULT_SENDER = os.getenv("TRANSALCA_MAIL_DEFAULT_SENDER", f"{MAIL_SENDER_NAME} <{MAIL_USERNAME}>")
APP_HOST = os.getenv("TRANSALCA_APP_HOST", "127.0.0.1")
APP_PORT = _env_int("TRANSALCA_APP_PORT", 5000)
APP_BASE_URL = os.getenv("APP_BASE_URL", os.getenv("TRANSALCA_BASE_URL", f"http://{APP_HOST}:{APP_PORT}")).rstrip("/")
